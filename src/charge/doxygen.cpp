 ...
 * @package charge
 *
 * Folder root for all the charge game engine parts.
 */

/**
 * @package charge.math
 *
 * Folder with math and simple objects.
 */

/**
 * @package charge.gfx
 *
 * Folder for the graphics subsystem.
 */

/**
 * @package charge.sfx
 *
 * Folder for the sound subsystem.
 */

/**
 * @package charge.ctl
 *
 * Folder for the input subsystem, such as Keyboard, Mouse and Joystick.
 */

/**
 * @package charge.net
 *
 * Folder for the network subsystem.
 */

/**
 * @package charge.phy
 *
 * Folder for the physics subsystem.
 */

/**
 * @package charge.sys
 *
 * Folder for system, resource and IO related parts.
 */

/**
 * @package charge.util
 *
 * Folder with (often) standalone utilities.
 */

/**
 * @package charge.platform
 *
 * Folder for code that dealwith platform specific things.
 */
...
typedef charge::game::app::RouterApp GameRouterApp;
typedef charge::game::lua::LuaState GameLuaState;
typedef charge::game::menu::MenuRunner GameMenuRunner;
typedef charge::game::runner::Runner GameRunner;
typedef charge::game::runner::Router GameRouter;
...
typedef charge::game::update::UpdateRunner GameUpdateRunner;
typedef charge::game::update::UpdateDownloader GameUpdateDownloader;
typedef charge::game::background::BackgroundRunner GameBackgroundRunner;
