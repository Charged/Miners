...
void function(GLuint program, GLuint inidex, GLchar* name) glBindAttribLocation;
...
void function(GLuint shader, GLsizei count, GLchar** strings, GLint* lengths) glShaderSource;
GLint function(GLint programObj, GLchar* name) glGetUniformLocation;
...
void function(GLuint inidex, GLdouble* v) glVertexAttrib1dv;
void function(GLuint inidex, GLfloat x) glVertexAttrib1f;
void function(GLuint inidex, GLfloat* v) glVertexAttrib1fv;
void function(GLuint inidex, GLshort x) glVertexAttrib1s;
void function(GLuint inidex, GLshort* v) glVertexAttrib1sv;
void function(GLuint inidex, GLdouble x, GLdouble y) glVertexAttrib2d;
void function(GLuint inidex, GLdouble* v) glVertexAttrib2dv;
void function(GLuint inidex, GLfloat x, GLfloat y) glVertexAttrib2f;
void function(GLuint inidex, GLfloat* v) glVertexAttrib2fv;
void function(GLuint inidex, GLshort x, GLshort y) glVertexAttrib2s;
void function(GLuint inidex, GLshort* v) glVertexAttrib2sv;
void function(GLuint inidex, GLdouble x, GLdouble y, GLdouble z) glVertexAttrib3d;
void function(GLuint inidex, GLdouble* v) glVertexAttrib3dv;
void function(GLuint inidex, GLfloat x, GLfloat y, GLfloat z) glVertexAttrib3f;
void function(GLuint inidex, GLfloat* v) glVertexAttrib3fv;
void function(GLuint inidex, GLshort x, GLshort y, GLshort z) glVertexAttrib3s;
void function(GLuint inidex, GLshort* v) glVertexAttrib3sv;
void function(GLuint inidex, GLbyte* v) glVertexAttrib4Nbv;
void function(GLuint inidex, GLint* v) glVertexAttrib4Niv;
void function(GLuint inidex, GLshort* v) glVertexAttrib4Nsv;
void function(GLuint inidex, GLubyte x, GLubyte y, GLubyte z, GLubyte w) glVertexAttrib4Nub;
void function(GLuint inidex, GLubyte* v) glVertexAttrib4Nubv;
void function(GLuint inidex, GLuint* v) glVertexAttrib4Nuiv;
void function(GLuint inidex, GLushort* v) glVertexAttrib4Nusv;
void function(GLuint inidex, GLbyte* v) glVertexAttrib4bv;
void function(GLuint inidex, GLdouble x, GLdouble y, GLdouble z, GLdouble w) glVertexAttrib4d;
void function(GLuint inidex, GLdouble* v) glVertexAttrib4dv;
void function(GLuint inidex, GLfloat x, GLfloat y, GLfloat z, GLfloat w) glVertexAttrib4f;
void function(GLuint inidex, GLfloat* v) glVertexAttrib4fv;
void function(GLuint inidex, GLint* v) glVertexAttrib4iv;
void function(GLuint inidex, GLshort x, GLshort y, GLshort z, GLshort w) glVertexAttrib4s;
void function(GLuint inidex, GLshort* v) glVertexAttrib4sv;
void function(GLuint inidex, GLubyte* v) glVertexAttrib4ubv;
void function(GLuint inidex, GLuint* v) glVertexAttrib4uiv;
void function(GLuint inidex, GLushort* v) glVertexAttrib4usv;
void function(GLuint inidex, GLint size, GLenum type, GLboolean normalized, GLsizei stride, GLvoid* pointer) glVertexAttribPointer;
