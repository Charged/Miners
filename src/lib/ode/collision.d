...
void function(dGeomID geom, ref dQuaternion Q) dGeomSetQuaternion;
dReal* function(dGeomID geom) dGeomGetPosition;
void function(dGeomID geom, ref dVector3 pos) dGeomCopyPosition;
...
void function(dGeomID geom, ref dQuaternion Q) dGeomSetOffsetQuaternion;
...
void function(dGeomID geom, ref dQuaternion) dGeomSetOffsetWorldQuaternion;
...
void function(dGeomID geom, ref dVector3 pos) dGeomCopyOffsetPosition;
dReal* function(dGeomID geom) dGeomGetOffsetRotation;
void function(dGeomID geom, dMatrix3 R) dGeomCopyOffsetRotation;
void function(dGeomID geom, ref dQuaternion result) dGeomGetOffsetQuaternion;
...
void function(dGeomID box, ref dVector3 result) dGeomBoxGetLengths;
...
void function(dGeomID plane, ref dVector4 result) dGeomPlaneGetParams;
...
void function(dGeomID ray, ref dVector3 start, ref dVector3 dir) dGeomRayGet;
...
void dGeomSetQuaternion(dGeomID geom, ref dQuaternion Q);
...
void dGeomSetOffsetQuaternion(dGeomID geom, ref dQuaternion Q);
...
void dGeomSetOffsetWorldQuaternion(dGeomID geom, ref dQuaternion);
